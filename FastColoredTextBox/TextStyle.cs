...
namespace FastColoredTextBoxNS
{
    ...
    public class TextStyle : Style
    {
        ...
        public TextStyle(Brush foreBrush, Brush backgroundBrush, FontStyle fontStyle, Brush topLineBrush = null, Brush bottomLineBrush = null)
        {
            ForeBrush = foreBrush;
            BackgroundBrush = backgroundBrush;
            TopLineBrush = topLineBrush;
            BottomLineBrush = bottomLineBrush;
            FontStyle = fontStyle;
        ...
        {
            int lineWidth = range.tb.CharWidth * 73;
            // draw line
            if (TopLineBrush != null)
                gr.FillRectangle(TopLineBrush, range.tb.CharWidth * 13, position.Y, lineWidth, 1);

            if (BottomLineBrush != null)
                gr.FillRectangle(BottomLineBrush, range.tb.CharWidth * 13, position.Y + range.tb.CharHeight, lineWidth, 1);

            //draw background
            if (BackgroundBrush != null)
                gr.FillRectangle(BackgroundBrush, range.tb.CharWidth * 13, position.Y, lineWidth, range.tb.CharHeight - 1);
